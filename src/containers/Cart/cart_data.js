export const cartData = [
  {
    ...
    name: "Slow Cooked Ribs Signature Box",
    detail: ["12 slow cooked ribs"],
    price: 58,
    quantity: 1,
  },
  {
    ...
    name: "Spicy California Hand Roll",
    detail: ["Kani Crab", "Avocado", "Cucumber", "Sambal Aioli"],
    price: 24,
    quantity: 2,
  },
  {
    ...
    name: "Zenko Roll",
    detail: ["Hamachi", "Yuzu Truffle Sauce"],
    price: 41,
    quantity: 4,
  },
];

...
function CommentGeneral({ _statusForm, _handleShowForm, _handleHideForm }) {
    ...
    return (
        ...
        <div class="comment-general">
            ...
            <h2 class="comment-general-header comment-general-header-mobile"> Đánh giá của khách hàng </h2>
        ...
        <div class="comment-sort">
            ...
            <div class="comment-sort-wrap">
                <select class="comment-sort-dropdown">
                    <option id="option-recent" value="Gần đây nhất">Gần đây nhất</option>
                    <option id="best-rate" value="Xếp hạng cao nhất">Xếp hạng cao nhất</option>
                    <option id="option-useful" value="Hữu ích nhất">Hữu ích nhất</option>
                    <option id="option-old" value="Cũ nhất">Cũ nhất</option>
                    <option id="bad-rate" value="Xếp hạng thấp nhất">Xếp hạng thấp nhất</option>
                </select>
            </div>
        </div>
    );
        ...
        <div class="comment-notification">
            <div class="comment-notification-container">
                ...
                <div class="notification-content">
                    Bạn có thể làm mới trang trong giây lát để xem đánh giá của bạn. Cảm ơn bạn đã ủng hộ sản phẩm và đánh giá!
                </div>
            </div>
        </div>
    );
    ...
    return (
        <div class="comment-form">
            <div class='comment-form-container'>
                <h2 class='comment-form-header comment-form-header-mobile'> Đánh giá của bạn </h2>
                        ...
                        <div class="comment-item-header">
                            ...
                            <div class="header-info">
                                ...
                                <div class="header-time">
                                    {item.comment_date}/{item.comment_month}/{item.comment_year}, {item.comment_hour}:{item.comment_minute}
                                </div>
                            </div>
